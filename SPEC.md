...
Cal.com — референсный сервис, на который можно опираться при проектировании пользовательского сценария.
...
Доменные сущности: владелец, тип события, слот, бронирование и публичный сценарий гостя
